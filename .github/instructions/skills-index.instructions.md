...
- `requesting-code-review`: prepare review scope and evidence.
- `receiving-code-review`: triage and prioritize review feedback.
- `review-loop-fastpath`: targeted re-review after findings are fixed.
