...
- In Claude Code, `Skill(...) Successfully loaded` is not initialization evidence. First-use init is complete only after the scan report records disk verification and `next_task_ready: yes`.
