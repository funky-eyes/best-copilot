...
- Subsequent conversations should invoke `repo-init-gate` and read only the target root `best-copilot.md` first. If that file's YAML frontmatter contains `version: "0.7.1"`, skip full repo-init artifact revalidation.
