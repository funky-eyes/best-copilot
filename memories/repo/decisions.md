...
- 2026-05-13: Blocking clarification, route selection, execution approval, continuation, and closeout must use native ask UI when available; prose-only questions must not end a turn. Safe non-destructive setup after "start development" should proceed directly instead of asking.
