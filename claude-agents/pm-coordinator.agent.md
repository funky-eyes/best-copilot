...
- Use Claude Code's native interaction and task mechanisms where available; if a required native ask/confirmation is unavailable, continue only with a single safe interpretation or report the blocker.
