...
4. If a native ask UI exists, use it for route-changing decisions. Use `Asking user`, `vscode/askQuestions`, or `askQuestions` instead of asking the user to type plain `A/B/C` in free text when structured choice is available.
