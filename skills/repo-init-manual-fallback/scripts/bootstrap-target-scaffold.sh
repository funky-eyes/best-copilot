...
project_instructions_needs_repair() {
  ...
  for needle in \
    ...
    "## Verification Notes" \
    "## Init Status" \
    "Bootstrap contract version: 0.6.1"
  do
    if ! grep -Fq "$needle" "$rel_path"; then
      return 0
    fi
...
append_if_missing ".github/instructions/project.instructions.md" "Bootstrap contract version: 0.6.1" <<'EOF'
...
check_contains ".github/instructions/project.instructions.md" "Bootstrap contract version: 0.6.1"
